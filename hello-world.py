...
code_reviewer_agent = autogen.AssistantAgent(
    ...
    system_message="You're a code tester. Execute the code with the provided functions and confirm it works",
...
software_engineer_agent = autogen.AssistantAgent(
    ...
    Example:
    Input: "print hello world in nodejs"
    Output: "console.log('hello world');"
    
    Example 2:
    Input: "Reverse a string in nodejs"
    Output: "function reverseString(str) {\n  return str.split('').reverse().join('');\n}\n\nconst inputString = 'hello world';\nconst reversedString = reverseString(inputString);\n console.log(reversedString);"
    
    Limit prose. Provide the code as a response.
    """,
    llm_config=llm_config,
)
# User proxy agent
...
res = user_proxy.initiate_chat(
    manager, 
    message="Print hello world in nodejs"
